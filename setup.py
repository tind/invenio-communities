...
install_requires = [
    ...
    "invenio-assets>=v1.0.0b1",  # Temp fix for bug in webassets
    'invenio-db>=1.0.0b1',
...
setup(
    ...
    entry_points={
        ...
        'invenio_assets.bundles': [
            ...
            'invenio_communities_select_js = ' +
            'invenio_communities.bundles:jsselect',
            'invenio_communities_select_css = ' +
            'invenio_communities.bundles:csselect'
        ]
    },
